...
class WebsiteSale(WebsiteSale):
    ...
    def checkout_form_validate(self, mode, all_form_values, data):
        ...
        error, error_message = super(WebsiteSale, self).checkout_form_validate(mode=mode,
        ...
        country_code = request.env['res.country'].sudo().search([('id', '=', all_form_values.get('country_id'))],
                                                                limit=1).code
